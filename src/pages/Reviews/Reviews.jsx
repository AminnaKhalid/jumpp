        ...
        <div className="flex flex-col w-full min-h-screen bg-[#FAFAFA]">
          ...
          <div className="flex flex-col bg-white rounded-lg shadow-sm h-screen py-6 px-4 mx-6 my-4 border-[#0000001A] border-[0.96px] text-[#00000080] text-sm font-medium leading-5">
            <div className="flex flex-col border-1 border-[#0000001A] my-2 mx-3 p-3 rounded-md">
              ...
              <div className="py-3 leading-7">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Et dolorem animi, ex hic laboriosam, impedit accusantium libero similique fugit eum earum officiis iusto? Saepe totam, illo fugit ratione similique amet.   Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto natus iste molestias sunt rem, incidunt tenetur earum sit aspernatur minus. Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur, laborum. </div>
            </div>
          </div>
        </div>
      </div>
